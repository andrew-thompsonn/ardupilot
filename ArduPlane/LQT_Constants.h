...
//circular
/* tempest - float GAINS_LAT_CIRCLE[2][6] = {
...
float GAINS_LAT_CIRCLE[2][6] = {
    {0.2136,0.7027,1.8258,4.5516,5.1363,0.0550},
    {0.1380,0.4269,1.1326,2.7897,3.2878,0.0352}
    };
float GAINS_LON_CIRCLE[2][6] = {
    {0.0081,-0.0508,0.3698,2.3294,-0.0326,-0.0215},
    {-0.0666,0.0172,-0.1216,-0.7224,-0.0190,0.0201}
    };
...
//straight line
/* tempest - float GAINS_LAT_LINE[2][6] = {
    {0.3722,0.3229,0.8161,7.3050,7.3625,0.0831},
    {0.2561,0.2052,0.5285,4.6685,5.1058,0.0607}
    };
float GAINS_LON_LINE[2][6] = {
    {0.0218,-0.0954,0.2807,3.0025,-0.0558,-0.0281},
    {-0.1627,0.0421,-0.1217,-1.2401,-0.0325,0.0434}
    };*/
// SITL aircraft
float GAINS_LAT_LINE[2][6] = {
    {0.2722,0.7809,2.1158,5.1490,6.5817,0.0795},
    {0.1777,0.4808,1.3336,3.2011,4.2722,0.0506}
    };
float GAINS_LON_LINE[2][6] = {
    {0.0113,-0.0728,0.5279,3.3565,-0.0435,-0.0382},
    {-0.0726,0.0138,-0.0965,-0.5602,-0.0264,0.0200}
    };
#endif