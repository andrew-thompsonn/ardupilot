...
public:
    ...
    {0.1453,0.0824,0.7720,2.8170,3.6422,0.0456},
    {0.4143,0.1795,1.4974,6.0806,9.6816,0.1494}
    };
    float GAINS_LON_LINE[2][6] = {
    {0.0037,-0.0789,0.0566,1.9371,-0.0646,-0.0089},
    {-0.0426,0.0191,-0.0135,-0.4572,-0.0091,0.0104}
    };
